...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminButton = findViewById(R.id.adminSelector);
...
//                                If able to make a user AND if admin is checked
//                                then make the user an admin in Firebase.
//                                Else make the user a user.
                                if(adminButton.isChecked()) {
                                    FirebaseAnalytics analytics = FirebaseAnalytics.getInstance(
                                            pupperlicks.getContext());
